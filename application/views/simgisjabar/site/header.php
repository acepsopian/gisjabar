<div class="navigation-bar fixed-top dark">
    <div class="navigation-bar-content"> 
        <a href="#" class="element"><span class="icon-location"></span> SIMGIS JABAR </a>
        ...
        <div class="element">
            <a class="dropdown-toggle" href="#">Grafik Pertanian</a>
            <ul class="dropdown-menu" data-role="dropdown">
                <li><a href="#" onclick="loadDashboard(false,true)">Per Propinsi</a></li>
            </ul>
        </div>
