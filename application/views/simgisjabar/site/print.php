	...
	<div class="details">
		...
		<div class="moredet">
			<table class="table detail">
				<tbody>	
					<tr><td width="120px">Golongan Aset</td><td width="5px">:</td><td id="golPrint"></td></tr>
					<tr><td width="100px">Bidang Aset</td><td width="5px">:</td><td id="bidPrint"></td></tr>
					<tr><td width="100px">Jumlah Aset</td><td width="5px">:</td><td id="cntPrint"></td></tr>
				</tbody>
			</table>
		</div>
	</div>
